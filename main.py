''''Initial Credits to ScriptLine Studios'''
...
enemies = []
for enemy in enemys:
    enemies.append(FlyingEnemy(enemy[0], enemy[1], "Enemigo"))
enemy_bullets = []
...
while menu:
    ...
    main_menu_text = framework.render_fps_font(FPS_FONT, "Abajo en la Mina")
    display.blit(main_menu_text, (42, 20))

    framework.render_button(display, "Jugar", FPS_FONT, False, (255,255,255), (125, 100), clicking, play, True)
    #print(lighting)
    if lighting:
        framework.render_button(display, "E para luz OFF", FPS_FONT, False, (255,255,255), (40, 135), False, fancy_lighting_off, False)

    if not lighting:
        framework.render_button(display, "E para luz ON", FPS_FONT, False, (255,255,255), (40, 135), False, fancy_lighting_on, False)
    clicking = False
...
while not menu:
    ...
    if int(gold_count) >= gold_per_level[map_index]:
        ...
        if map_index != 3:
            ...
            text4 = framework.render_fps_font(FONT, "Ganaste!")
    ...
    if map_index == 0:
        text = framework.render_fps_font(SMALL_FONT, "Caza el oro")
        display.blit(text, (150-scroll[0], 100-scroll[1]))

        text2 = framework.render_fps_font(SMALL_FONT, "Click para la bomba")
        display.blit(text2, (80-scroll[0], -50-scroll[1]))

    if dead:
        
        text3 = framework.render_fps_font(FPS_FONT, "FIN, Enter para reiniciar...")
    ...
    gold_count_text = framework.render_fps_font(FPS_FONT, f"Oro: {gold_count}/{gold_per_level[map_index]}")
